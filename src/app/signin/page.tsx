...
const Button = ({ children, variant = "default", disabled = false, onClick, type = "button", className = "" }) => {
...
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur border-b border-gray-800">
    <div className="container mx-auto px-4 h-16 flex items-center justify-between">
      <div className="text-xl font-bold text-white flex gap-4 items-center"><img src="/assets/psgtechlogo.jpeg" alt="" width="40px" height="30px" /><p>AI4Dev '26</p></div>
...
export default function SignIn() {
  ...
  const handleSignIn = async (e) => {
    ...
    // Admin Check
    if (credentials.email === 'admin@ai4dev.com' && credentials.password === 'Admin@2026') {
      setFeedback({ type: 'success', message: 'Admin Verified. Redirecting...' });
  ...
  const handleConfirmReset = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setFeedback({ type: 'success', message: 'Password Changed! Please Login.' });
        setTimeout(() => {
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              {isResetMode 
                ? (resetStep === 1 ? "Enter your email to receive an OTP" : "Enter OTP and new password")
          ...
          <Card className="p-8">
            ...
            {isResetMode && (
              <div className="space-y-6">
                {resetStep === 1 ? (
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-white">Registered Email</label>
                    <Input
                      type="email"
                      name="email"
                      placeholder="your@email.com"
                ...
                <Button
                  type="button"
                  onClick={resetStep === 1 ? handleSendResetOtp : handleConfirmReset}
                  disabled={loading}
                  className="w-full"
                >
                  {loading ? (
